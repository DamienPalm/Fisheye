...
const render = (photographer) => {
  return `
    <div class="modal-background" id="contact-modal" role="dialog" aria-labelledby="Contact me ${photographer.name}" aria-describedby="Contact form">
      <div class="modal-background__modal">
        <header class="modal-background__modal__header">
          ...
          <img class="modal-background__modal__header__closeButton" src="./assets/icons/close.svg" id="close-button" aria-label="Close contact form">
        </header>
        <form action="#" method="post" class="modal-background__modal__form" name="contact-me">
          ...
          <button class="modal-background__modal__form__button" aria-label="Send">Envoyer</button>
        </form>
      </div>
    </div>
    `;
